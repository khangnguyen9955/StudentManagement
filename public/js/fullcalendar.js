!(function (e, t) {
        ...
        (Xr.prototype.registerInteractiveComponent = function (e, t) {
            var n,
                r = {
                    ...
                    el: (n = t).el,
                    useEventCenter:
                        null == n.useEventCenter || n.useEventCenter,
                },
                i = [Fr, Ar]
    ...
    (function (e, t) {
        ...
        function K(e, t) {
            ...
            return new R.DayTable(
                n,
                /year|month|week/.test(e.currentRangeUnit)
            );
        }
            ...
            a =
                ...
                (l.prototype.groupSegsByDay = function (e) {
                    for (var t, n = [], r = 0; r < e.length; r++)
                        (n[(t = e[r]).dayIndex] || (n[t.dayIndex] = [])).push(
                            t
                        );
                    return n;
                }),
        ...
        function I() {
            ...
            return (
                ...
                (a.renderTimeGridIntroHtml = function () {
                    return (
                        '<td class="fc-axis" ' + a.axisStyleAttr() + "></td>"
                    );
                }),
