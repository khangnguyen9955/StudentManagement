...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=yes"><link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Open+Sans'><link rel="stylesheet" href="{{url('css/style.css')}}">
    ...
    <div class="login">
      ...
      <div class="login__form">
        <div class="login__row">
          ...
          <input type="text" class="login__input name" name="email" value="{{old('email')}}" placeholder="Email"/>
        ...
        <div class="login__row">
          ...
          <input type="password" class="login__input pass" name="password" value="{{old('password')}}" placeholder="Password"/>
