                  ...
                  <form class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-8 mb-3">
                        ...
                        <input type="password" class="form-control" id="123456" placeholder="Enter your password" required>
                        <div class="invalid-feedback"> Please enter your password</div>
                        <small id="emailHelp1" class="form-text text-muted">We'll never share your password with anyone else.</small>
                      </div>
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" id="address-wpalaceholder" class="form-control" placeholder="Enter your phone number" required>
